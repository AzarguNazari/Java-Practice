...
/**
 * A JUnit test case providing examples of how {@link Locale} and 'locale-sensitive' Java APIs (that
 ...
 * In Java 7, the {@link Locale} class was enhanced to support / use the IETF BCP 47 standard for
 ...
 * sub-tag specific. For more details see the  {@link Locale} class Javadoc.
 * <p>
 ...
 * see the {@link Locale} class Javadoc, section 'Unicode locale/language extension'.
 *
 ...
 * <ul>
 * <li>'currency type' (as defined by LDML keyword 'cu') - For example, the {@link Currency#getInstance(Locale)}
 ...
 * - A useful primer / reminder of how {@link Locale} can be used to support i18n in Java apps.
 */
