...
public class AdHocMethods {
    ...
    @Test
    public void report() {
        Megacorp megacorp = new SimpleMegacorp("name", new BigDecimal("1234"), new BigDecimal("12345"));
        ...
        Assertions.assertThat(corp.name()).isNotEmpty();
        Assertions.assertThat(corp.isEvil()).isIn(true, false);
        Assertions.assertThat(corp.isSuccessful()).isIn(true, false);
        System.out.printf(
