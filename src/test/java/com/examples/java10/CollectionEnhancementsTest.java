 ...
 * In J10, the {@link List}, {@link Map} and {@link Set} interfaces have been extended to support creating
 * these types from an immutable copy of a supplied {@link Collection}, using a new static factory named
...
public class CollectionEnhancementsTest {
   ...
   * that implements {@link Collection}). Attempts to do so result in a compilation error, due to a mismatch
